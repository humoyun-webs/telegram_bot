...
from states.HomeDachaState import HomeDacha
from config import *
...
@dp.message_handler(Text(startswith="Дача"), state=None)
async def first(message: types.Message):
    await message.answer("Ҳудудни танланг: ", reply_markup=regions)
    await HomeDacha.region.set()


@dp.callback_query_handler(text='toshkent_shahar', chat_type="private", state=HomeDacha.region)
async def tashkent(callback_query: types.CallbackQuery, state: FSMContext):
    ...
    await HomeDacha.next()


@dp.callback_query_handler(text='Toshkent viloyati', chat_type="private", state=HomeDacha.region)
async def tashkent(callback_query: types.CallbackQuery, state: FSMContext):
...
@dp.callback_query_handler(text='Andijon', chat_type="private", state=HomeDacha.region)
...
@dp.callback_query_handler(text='Namangan', chat_type="private", state=HomeDacha.region)
async def tashkent(callback_query: types.CallbackQuery, state: FSMContext):
...
@dp.callback_query_handler(text="Farg'ona", chat_type="private", state=HomeDacha.region)
async def tashkent(callback_query: types.CallbackQuery, state: FSMContext):
...
@dp.callback_query_handler(text='Samarqand', chat_type="private", state=HomeDacha.region)
async def tashkent(callback_query: types.CallbackQuery, state: FSMContext):
...
@dp.callback_query_handler(text='Buxoro', chat_type="private", state=HomeDacha.region)
async def tashkent(callback_query: types.CallbackQuery, state: FSMContext):
    text = "#Бухоро   #Вилояти"
    await callback_query.answer("Pressed")
...
@dp.callback_query_handler(text="Sirdaryo", chat_type="private", state=HomeDacha.region)
async def tashkent(callback_query: types.CallbackQuery, state: FSMContext):
...
@dp.callback_query_handler(text="Qashqadaryo", chat_type="private", state=HomeDacha.region)
async def tashkent(callback_query: types.CallbackQuery, state: FSMContext):
...
@dp.callback_query_handler(text="Surxandaryo", chat_type="private", state=HomeDacha.region)
async def tashkent(callback_query: types.CallbackQuery, state: FSMContext):
...
@dp.callback_query_handler(text="Navoiy", chat_type="private", state=HomeDacha.region)
async def tashkent(callback_query: types.CallbackQuery, state: FSMContext):
    text = "#Навоий   #Вилояти"
    await callback_query.answer("Pressed")
...
@dp.callback_query_handler(text="Jizzax", chat_type="private", state=HomeDacha.region)
async def tashkent(callback_query: types.CallbackQuery, state: FSMContext):
    text = "#Жиззах   #Вилояти"
    await callback_query.answer("Pressed")
...
@dp.callback_query_handler(text="Xorazm", chat_type="private", state=HomeDacha.region)
async def tashkent(callback_query: types.CallbackQuery, state: FSMContext):
    text = "#Хоразм   #Вилояти"
    await callback_query.answer("Pressed")
...
@dp.callback_query_handler(text="Qoraqalpog'iston", chat_type="private", state=HomeDacha.region)
async def tashkent(callback_query: types.CallbackQuery, state: FSMContext):
...
@dp.message_handler(state=HomeDacha.umumiyMaydon)
...
@dp.message_handler(lambda message: not message.text.isdigit(), state=HomeDacha.xonalar)
async def check_umumiy(message: types.Message):
    await message.reply("❗ Фақат рақамда ёзинг")


@dp.message_handler(state=HomeDacha.xonalar)
async def umumiyMaydon(message: types.Message, state: FSMContext):
    text = message.text
...
@dp.message_handler(lambda message: not message.text.isdigit(), state=HomeDacha.qavatlik)
async def check_umumiy(message: types.Message):
    await message.reply("❗ Фақат рақамда ёзинг")


@dp.message_handler(state=HomeDacha.qavatlik)
async def umumiyMaydon(message: types.Message, state: FSMContext):
    text = message.text
...
@dp.callback_query_handler(text='Evroremont', state=HomeDacha.remont, chat_type="private")
...
@dp.callback_query_handler(text="Ta'mirlangan", state=HomeDacha.remont, chat_type="private")
async def kvartira(callback_query: types.CallbackQuery, state: FSMContext):
    text = "Таъмирланган"
    await callback_query.answer("Pressed")
    await state.update_data({
...
@dp.callback_query_handler(text="O'rtacha", state=HomeDacha.remont, chat_type="private")
async def kvartira(callback_query: types.CallbackQuery, state: FSMContext):
    text = "Ўртача"
    await callback_query.answer("Pressed")
    await state.update_data({
...
@dp.callback_query_handler(text="Ta'mirsiz", state=HomeDacha.remont, chat_type="private")
async def kvartira(callback_query: types.CallbackQuery, state: FSMContext):
    text = "Таъмирсиз"
    await callback_query.answer("Pressed")
    await state.update_data({
...
@dp.callback_query_handler(text='Mavjud', state=HomeDacha.jihozlar, chat_type="private")
async def kvartira(callback_query: types.CallbackQuery, state: FSMContext):
    text = "бор"
    await callback_query.answer("Pressed")
    await state.update_data({
...
@dp.callback_query_handler(text='Jihozlarsiz', state=HomeDacha.jihozlar, chat_type="private")
async def kvartira(callback_query: types.CallbackQuery, state: FSMContext):
    text = "йўқ"
    await callback_query.answer("Pressed")
    await state.update_data({
...
# ===================================================================
@dp.callback_query_handler(text="bor", state=HomeDacha.gaz)
...
@dp.callback_query_handler(text="yoq", state=HomeDacha.gaz)
async def xonalar(callback_query: types.CallbackQuery, state: FSMContext):
    text = "Mavjud emas"
    await callback_query.answer("Танланди")
...
@dp.callback_query_handler(text="bor", state=HomeDacha.svet)
async def xonalar(callback_query: types.CallbackQuery, state: FSMContext):
    text = "Свет ✅"
    await callback_query.answer("Танланди")
...
@dp.callback_query_handler(text="yoq", state=HomeDacha.svet)
async def xonalar(callback_query: types.CallbackQuery, state: FSMContext):
    text = "Mavjud emas"
    await callback_query.answer("Танланди")
...
@dp.callback_query_handler(text="bor", state=HomeDacha.suv)
async def xonalar(callback_query: types.CallbackQuery, state: FSMContext):
    text = "Сув ✅"
...
@dp.callback_query_handler(text="yoq", state=HomeDacha.suv)
async def xonalar(callback_query: types.CallbackQuery, state: FSMContext):
    text = "Mavjud emas"
    await callback_query.answer("Tanlandi")
...
# ========================================================================
@dp.callback_query_handler(text="bor", state=HomeDacha.kanalizatsiya)
async def xonalar(callback_query: types.CallbackQuery, state: FSMContext):
    text = "Канализация ✅"
    await callback_query.answer("Tanlandi")
...
@dp.callback_query_handler(text="yoq", state=HomeDacha.kanalizatsiya)
async def xonalar(callback_query: types.CallbackQuery, state: FSMContext):
    text = "Mavjud emas"
    await callback_query.answer("Tanlandi")
...
@dp.message_handler(state=HomeDacha.qoshimchaMalumot)
async def umumiyMaydon(message: types.Message, state: FSMContext):
    text = message.text
    await state.update_data({
...
@dp.callback_query_handler(text='USD', state=HomeDacha.valyuta, chat_type="private")
async def kvartira(callback_query: types.CallbackQuery, state: FSMContext):
    text = " $"
    await callback_query.answer("Pressed")
...
@dp.callback_query_handler(text='SUM', state=HomeDacha.valyuta, chat_type="private")
async def kvartira(callback_query: types.CallbackQuery, state: FSMContext):
    text = " сўм"
    await callback_query.answer("Pressed")
...
@dp.message_handler(state=HomeDacha.narxi)
...
@dp.message_handler(state=HomeDacha.manzil)
async def umumiyMaydon(message: types.Message, state: FSMContext):
    text = message.text
    await state.update_data({
        "manzil": text
...
@dp.message_handler(state=HomeDacha.moljal)
async def umumiyMaydon(message: types.Message, state: FSMContext):
    text = message.text
    await state.update_data({
        "moljal": text
...
@dp.message_handler(state=HomeDacha.telNumberOne)
async def umumiyMaydon(message: types.Message, state: FSMContext):
...
@dp.message_handler(state=HomeDacha.telNumberTwo)
async def umumiyMaydon(message: types.Message, state: FSMContext):
    text = message.text
    await state.update_data({
        "telNumberTwo": text
...
@dp.message_handler(is_media_group=True, state=HomeDacha.images, content_types=types.ContentTypes.PHOTO)
async def images(message: types.Message, album: List[types.Message], state: FSMContext):
    ...
    if data['qoshimchaMalumot'] == "⏭️ Кейингиси" and data['telNumberTwo'] == "⏭️ Кейингиси":
        if data['gaz'] == "Mavjud emas" and data['svet'] == "Mavjud emas" and data['suv'] == "Mavjud emas" and data[
            ...
            data4 = "♦️ Хоналар сони: " + data['xonalar'] + " та" + "\n"

            data6 = "♦️ Неча қаватли: " + data['qavatlik'] + "\n"
            data7 = "♦️ Ремонти: " + data['remont'] + "\n"
            data8 = "♦️ Жиҳозлари: " + data['jihozlar'] + "\n"
            data9 = "♦️ " + "йўқ" + "\n"
            data11 = "♦️ Нархи: " + data['narxi'] + data['valyuta'] + "\n\n"
            data12 = "📌 Манзил: " + data['manzil'] + "\n"
            data13 = "📌 Мўлжал:  " + data['moljal'] + "\n\n"
            data15 = "☎️ Тел: " + data['telNumberOne'] + "\n"

            result = data1 + data2 + data3 + data4 + data6 + data7 + data8 + data9 + data11 + data12 + data13 + data15
            ...
            data7 = "♦️ Ремонти: " + data['remont'] + "\n"
            data8 = "♦️ Жиҳозлари: " + data['jihozlar'] + "\n"
            data9 = "♦️ " + data['kanalizatsiya'] + " бор" + "\n"
            data11 = "♦️ Нархи: " + data['narxi'] + data['valyuta'] + "\n\n"
            data12 = "📌 Манзил: " + data['manzil'] + "\n"
            data13 = "📌 Мўлжал:  " + data['moljal'] + "\n\n"
            data15 = "☎️ Тел: " + data['telNumberOne'] + "\n"
            ...
            data7 = "♦️ Ремонти: " + data['remont'] + "\n"
            data8 = "♦️ Жиҳозлари: " + data['jihozlar'] + "\n"
            data9 = "♦️ " + data['suv'] + ", " + data['kanalizatsiya'] + " бор" + "\n"
            data11 = "♦️ Нархи: " + data['narxi'] + data['valyuta'] + "\n\n"
            data12 = "📌 Манзил: " + data['manzil'] + "\n"
            data13 = "📌 Мўлжал:  " + data['moljal'] + "\n\n"
            data15 = "☎️ Тел: " + data['telNumberOne'] + "\n"
            ...
            data7 = "♦️ Ремонти: " + data['remont'] + "\n"
            data8 = "♦️ Жиҳозлари: " + data['jihozlar'] + "\n"
            data9 = "♦️ " + data['svet'] + ", " + data['kanalizatsiya'] + " бор" + "\n"
            data11 = "♦️ Нархи: " + data['narxi'] + data['valyuta'] + "\n\n"
            data12 = "📌 Манзил: " + data['manzil'] + "\n"
            data13 = "📌 Мўлжал:  " + data['moljal'] + "\n\n"
            data15 = "☎️ Тел: " + data['telNumberOne'] + "\n"
            ...
            data7 = "♦️ Ремонти: " + data['remont'] + "\n"
            data8 = "♦️ Жиҳозлари: " + data['jihozlar'] + "\n"
            data9 = "♦️ " + data['suv'] + ", " + data['svet'] + " бор" + "\n"
            data11 = "♦️ Нархи: " + data['narxi'] + data['valyuta'] + "\n\n"
            data12 = "📌 Манзил: " + data['manzil'] + "\n"
            data13 = "📌 Мўлжал:  " + data['moljal'] + "\n\n"
            data15 = "☎️ Тел: " + data['telNumberOne'] + "\n"
            ...
            data7 = "♦️ Ремонти: " + data['remont'] + "\n"
            data8 = "♦️ Жиҳозлари: " + data['jihozlar'] + "\n"
            data9 = "♦️ " + data['gaz'] + ", " + data['kanalizatsiya'] + " бор" + "\n"
            data11 = "♦️ Нархи: " + data['narxi'] + data['valyuta'] + "\n\n"
            data12 = "📌 Манзил: " + data['manzil'] + "\n"
            data13 = "📌 Мўлжал:  " + data['moljal'] + "\n\n"
            data15 = "☎️ Тел: " + data['telNumberOne'] + "\n"
            ...
            data7 = "♦️ Ремонти: " + data['remont'] + "\n"
            data8 = "♦️ Жиҳозлари: " + data['jihozlar'] + "\n"
            data9 = "♦️ " + data['gaz'] + ", " + data['svet'] + " бор" + "\n"
            data11 = "♦️ Нархи: " + data['narxi'] + data['valyuta'] + "\n\n"
            data12 = "📌 Манзил: " + data['manzil'] + "\n"
            data13 = "📌 Мўлжал:  " + data['moljal'] + "\n\n"
            data15 = "☎️ Тел: " + data['telNumberOne'] + "\n"
            ...
            data7 = "♦️ Ремонти: " + data['remont'] + "\n"
            data8 = "♦️ Жиҳозлари: " + data['jihozlar'] + "\n"
            data9 = "♦️ " + data['svet'] + ", " + data['suv'] + ", " + data[
                'kanalizatsiya'] + " бор" + "\n"
            data11 = "♦️ Нархи: " + data['narxi'] + data['valyuta'] + "\n\n"
            data12 = "📌 Манзил: " + data['manzil'] + "\n"
            data13 = "📌 Мўлжал:  " + data['moljal'] + "\n\n"
            ...
            data7 = "♦️ Ремонти: " + data['remont'] + "\n"
            data8 = "♦️ Жиҳозлари: " + data['jihozlar'] + "\n"
            data9 = "♦️ " + data['gaz'] + ", " + data['suv'] + ", " + data[
                'kanalizatsiya'] + " бор" + "\n"
            data11 = "♦️ Нархи: " + data['narxi'] + data['valyuta'] + "\n\n"
            data12 = "📌 Манзил: " + data['manzil'] + "\n"
            data13 = "📌 Мўлжал:  " + data['moljal'] + "\n\n"
            ...
            data7 = "♦️ Ремонти: " + data['remont'] + "\n"
            data8 = "♦️ Жиҳозлари: " + data['jihozlar'] + "\n"
            data9 = "♦️ " + data['gaz'] + ", " + data['svet'] + ", " + data[
                'kanalizatsiya'] + " бор" + "\n"
            data11 = "♦️ Нархи: " + data['narxi'] + data['valyuta'] + "\n\n"
            data12 = "📌 Манзил: " + data['manzil'] + "\n"
            data13 = "📌 Мўлжал:  " + data['moljal'] + "\n\n"
            ...
            data7 = "♦️ Ремонти: " + data['remont'] + "\n"
            data8 = "♦️ Жиҳозлари: " + data['jihozlar'] + "\n"
            data9 = "♦️ " + data['gaz'] + ", " + data['svet'] + ", " + data['suv'] + " бор" + "\n"
            data11 = "♦️ Нархи: " + data['narxi'] + data['valyuta'] + "\n\n"
            data12 = "📌 Манзил: " + data['manzil'] + "\n"
            data13 = "📌 Мўлжал:  " + data['moljal'] + "\n\n"
            data15 = "☎️ Тел: " + data['telNumberOne'] + "\n"
            ...
            data7 = "♦️ Ремонти: " + data['remont'] + "\n"
            data8 = "♦️ Жиҳозлари: " + data['jihozlar'] + "\n"
            data9 = "♦️ " + data['gaz'] + ", " + data['svet'] + ", " + data['suv'] + ", " + data[
                'kanalizatsiya'] + " бор" + "\n"
            data11 = "♦️ Нархи: " + data['narxi'] + data['valyuta'] + "\n\n"
            data12 = "📌 Манзил: " + data['manzil'] + "\n"
            data13 = "📌 Мўлжал:  " + data['moljal'] + "\n\n"
    ...
    # ============================================================================================
        ...
        if data['gaz'] == "Mavjud emas" and data['svet'] == "Mavjud emas" and data['suv'] == "Mavjud emas" and data[
            ...
            result = data1 + data2 + data3 + data4 + data6 + data7 + data8 + data9 + data11 + data12 + data13 + data16
            cyrillic_text = to_cyrillic(result)
            ...
            result = data1 + data2 + data3 + data4 + data6 + data7 + data8 + data9 + data11 + data12 + data13 + data15 + data16
            cyrillic_text = to_cyrillic(result)
    ...
    # ================================================================================================
        ...
        if data['gaz'] == "Mavjud emas" and data['svet'] == "Mavjud emas" and data['suv'] == "Mavjud emas" and data[
            ...
            data8 = "♦️ Жиҳозлари: " + data['jihozlar'] + "\n"
            data9 = "♦️ " + "Йўқ" + "\n"
            data10 = "♦️ Қўшимча маълумот: " + data['qoshimchaMalumot'] + "\n"
            data11 = "♦️ Нархи: " + data['narxi'] + data['valyuta'] + "\n\n"
            data12 = "📌 Манзил: " + data['manzil'] + "\n"
            data13 = "📌 Мўлжал:  " + data['moljal'] + "\n\n"
            data15 = "☎️ Тел: " + data['telNumberOne'] + "\n"

            result = data1 + data2 + data3 + data4 + data6 + data7 + data8 + data9 + data10 + data11 + data12 + data13 + data15
            cyrillic_text = to_cyrillic(result)
    ...
    # =============================================================================================
        ...
        if data['gaz'] == "Mavjud emas" and data['svet'] == "Mavjud emas" and data['suv'] == "Mavjud emas" and data[
            ...
            result = data1 + data2 + data3 + data4 + data6 + data7 + data8 + data9 + data10 + data11 + data12 + data13 + data15 + data16
            cyrillic_text = to_cyrillic(result)
...
@dp.message_handler(state=HomeDacha.check)
